...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (CMR, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up cm-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (cm-entity-missing -> HARD hold) ==")
